...
/**
 * IteratorBwd class implements the Iterator interface for traversing a linked list of LakeRecords.
 * It provides methods for accessing previous item and checking if there is another to access.
 */
